...
class TestChannelsPrometheus(TestCase):
    ...
    async def test_async_websocket_counter(self):
        ...
        self.websocketCommunicator4 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
        self.websocketCommunicator5 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
        self.websocketCommunicator6 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
        self.websocketCommunicator7 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
        self.websocketCommunicator8 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
        self.websocketCommunicator9 = WebsocketCommunicator(
            AsyncTestConsumer.as_asgi(), "/ws/test/"
        )
